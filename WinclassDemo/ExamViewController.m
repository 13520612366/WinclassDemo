...
@synthesize horiScroller;
@synthesize yearChoice;
#pragma mark -
...
-(void) initData
{
    ...
    theScroller.contentSize=CGSizeMake(280,1000);
       
	horiScroller.contentSize=CGSizeMake(1150,35);
    //init local data
       sSelectYear = nil;
...
-(IBAction)doSearch:(id)sender{
    ...
    QListViewController *qListViewCtrl = [[QListViewController alloc] init];
